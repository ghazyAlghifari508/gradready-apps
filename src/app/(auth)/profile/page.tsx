  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px" }}>
      ...
      <p style={{ color: "var(--gray-text)", marginBottom: 32 }}>
        Atur informasi dasar, tautan profesional, dan pantau lencana
        pencapaianmu.
      </p>
          ...
          >
            <Card className="bg-transparent border-0">
              ...
              {badges.length > 0 ? (
                  ...
                  {badges.map((badge: (typeof badges)[0]) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {isFullyReady ? (
                            <Trophy size={48} color="#1a1855" />
                          ) : (
                            <Award size={48} color="var(--green)" />
                          )}
                        </div>
                        <div
                          style={{
                ...
                >
                  Belum ada lencana yang diraih. Kerjakan kuis & roadmap untuk
                  meningkatkan skor Readiness!
                </div>
              )}
            </Card>
          </div>
