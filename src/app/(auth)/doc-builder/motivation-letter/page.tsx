...
export default function MotivationLetterPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 md:p-10">
      <div className="mb-8">
        <h1 className="text-3xl font-display text-(--green) mb-2">
          Motivation Letter Builder
        </h1>
        <p className="text-gray-600">
          Dokumen formal untuk mendeskripsikan motivasi Anda.
        </p>
      </div>
          ...
          <Card className="border border-gray-200">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-500 italic">
                *Data profil Anda (universitas, nama, skill) akan diisi otomatis
                ke dalam surat oleh AI.
              </p>
              <Button
                className="w-full"
                onClick={handleGenerate}
                disabled={
                  loading || !formData.companyName || !formData.position
                }
              >
                {loading
                  ? "AI Sedang Menulis..."
