    ...
    <div className="min-h-screen bg-white font-['Nunito',sans-serif] text-gray-700 overflow-x-clip">
          ...
          <div className="bg-[#e6fcd2] border-2 border-[#c0f590] border-b-[8px] rounded-[32px] p-8 relative overflow-hidden flex flex-col justify-between aspect-square hover:-translate-y-2 transition-transform">
            ...
            <div>
              ...
              <p className="text-[#4BB200] font-bold">
                Unggah CV kamu dan biarkan AI kami memberikan penilaian akurat
                dan saran perbaikan!
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#58CC02] border-2 border-[#4BB200] border-b-[8px] rounded-[32px] p-8 relative overflow-hidden flex flex-col justify-between aspect-square text-white lg:scale-105 z-10 lg:-translate-y-8 hover:-translate-y-10 transition-transform">
            ...
            <div>
              ...
              <p className="text-white font-bold">
                Ketahui skill apa yang belum kamu miliki untuk posisi impian di
                perusahaan ternama.
              </p>
            </div>
          </div>
          ...
          <div className="bg-yellow-400 border-2 border-yellow-500 border-b-[8px] rounded-[32px] p-8 relative overflow-hidden flex flex-col justify-between aspect-square hover:-translate-y-2 transition-transform">
            ...
            <div>
              ...
              <p className="text-yellow-900 font-bold">
                Dapatkan rekomendasi jalur belajar yang personal untuk
                meningkatkan peluang kerjamu!
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex-1">
          ...
          <p className="text-gray-500 font-bold mb-10 max-w-md text-lg">
            Jangan khawatir! Meskipun belum banyak pengalaman, kami siap
            mengarahkanmu langkah demi langkah agar lolos screening otomatis ATS
            HRD.
          </p>
        ...
        <div className="flex-1 relative min-h-[400px] w-full">
          ...
          <div className="absolute bottom-[10%] right-[5%] w-48 md:w-64 h-20 md:h-24 bg-yellow-400 rounded-full border-[6px] border-white shadow-xl z-30 flex items-center justify-center">
            <span className="text-4xl text-white font-['Fredoka_One']">
              ATS Friendly
            </span>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white border-2 border-gray-200 border-b-[8px] rounded-[32px] p-8 text-center hover:-translate-y-1 transition-transform">
            ...
            <p className="font-bold text-gray-400 uppercase tracking-wide">
              Mahasiswa Bergabung
            </p>
          </div>
          <div className="bg-white border-2 border-gray-200 border-b-[8px] rounded-[32px] p-8 text-center hover:-translate-y-1 transition-transform">
            <h3 className="font-['Fredoka_One'] text-5xl text-[#FF4B4B] mb-2">
              50+
            </h3>
            <p className="font-bold text-gray-400 uppercase tracking-wide">
              Universitas Mitra
          ...
          <div className="bg-white border-2 border-gray-200 border-b-[8px] rounded-[32px] p-8 text-center hover:-translate-y-1 transition-transform">
            <h3 className="font-['Fredoka_One'] text-5xl text-[#FFC800] mb-2">
              95%
            </h3>
            <p className="font-bold text-gray-400 uppercase tracking-wide">
              Tingkat Kepuasan
      ...
      <div className="relative w-full">
        ...
        <section className="max-w-7xl mx-4 xl:mx-auto bg-[#1CB0F6] py-24 px-6 border-b-[12px] border-[#1899D6] rounded-[48px] my-10 text-white relative overflow-hidden sticky top-8 z-10 transition-transform">
          ...
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10">
            <div className="flex-1">
              <h2 className="font-['Fredoka_One'] text-4xl md:text-5xl mb-6 leading-tight">
                Ikuti panduan <br /> langkah demi langkah!
              </h2>
              <p className="font-bold text-blue-100 text-lg md:text-xl mb-10 max-w-md">
                Mulai dari evaluasi CV, melihat rekomendasi karir, hingga
                simulasi wawancara. Ikuti roadmap komprehensif ini untuk
                mempersiapkan dirimu menjadi kandidat terbaik!
              </p>
            ...
            <div className="flex-1 flex justify-center relative min-h-[300px] w-full">
              ...
              <div className="absolute top-[40%] right-[30%] w-20 h-20 bg-[#58CC02] rounded-full border-4 border-[#c0f590] shadow-[0_6px_0_#4BB200] z-20 flex items-center justify-center transform hover:-translate-y-2 transition-all cursor-pointer">
                <span className="text-3xl text-white font-['Fredoka_One']">
                  1
                </span>
              </div>
              ...
              <svg
                ...
                style={{ filter: "drop-shadow(0 4px 0 rgba(0,0,0,0.1))" }}
              >
                <path
                  d="M 120 80 Q 250 150 280 180"
                  fill="none"
                  stroke="white"
                  strokeWidth="16"
                  strokeLinecap="round"
        ...
        <section className="max-w-7xl mx-4 xl:mx-auto bg-[#FF4B4B] py-24 px-6 border-b-[12px] border-[#D33131] rounded-[48px] my-10 text-white text-center sticky top-16 z-20 shadow-[0_-10px_30px_rgba(0,0,0,0.1)] transition-transform">
          <h2 className="font-['Fredoka_One'] text-4xl md:text-5xl mb-6">
            Takut Wawancara Kerja?
          </h2>
          <p className="max-w-2xl mx-auto font-bold text-red-100 text-lg mb-12">
            Latih skill bicaramu dengan bot AI kami yang dirancang seperti
            rekuter sungguhan. Dapatkan feedback instan mengenai nada suara,
            kejelasan, dan kepercayaan dirimu.
          </p>
            ...
            <div className="bg-white rounded-[32px] p-6 border-b-[8px] border-red-200 text-left flex gap-6 items-start shadow-xl transform -rotate-1">
              ...
              <div className="bg-gray-100 rounded-2xl p-5 flex-1 rounded-tl-none border-2 border-gray-200">
                <p className="text-gray-600 font-bold text-lg leading-snug">
                  &quot;Coba ceritakan tentang pengalaman proyek terbesarmu saat
                  di bangku kuliah!&quot;
                </p>
              </div>
            </div>
        ...
        <section className="max-w-7xl mx-4 xl:mx-auto bg-[#58CC02] text-white rounded-[48px] my-10 py-24 px-6 relative overflow-hidden border-b-[12px] border-[#4BB200] sticky top-24 z-30 shadow-[0_-10px_30px_rgba(0,0,0,0.1)] transition-transform">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20 relative z-10">
            <h2 className="font-['Fredoka_One'] text-4xl md:text-5xl leading-tight">
              Tujuan kami membantu lulusan menembus{" "}
      ...
      >
        <div className="flex-1">
          <h2 className="font-['Fredoka_One'] text-4xl md:text-5xl mb-6 text-gray-800">
            Dibuat untuk{" "}
            <span className="text-[#FFC800] border-b-8 border-[#FFC800]">
              kalian
            </span>
          </h2>
          <p className="text-gray-500 font-bold text-lg mb-6 leading-relaxed">
            GradReady didirikan dengan satu misi: menutup kesenjangan antara
            kemahiran akademis dan ekspektasi nyata dari industri. Kami sadar
            bahwa banyak fresh graduate kebingungan di tahap awal mencari
            pekerjaan.
          </p>
          <p className="text-gray-500 font-bold text-lg leading-relaxed">
            Menggabungkan teknologi AI pintar dengan tahapan persiapan yang
            interaktif, kami menyajikan platform yang personal, akurat, dan
            ramah pengguna untuk membantumu bersaing di dunia kerja.
          </p>
        </div>
        <div className="flex-1 grid grid-cols-2 gap-4">
          <div className="bg-[#e6fcd2] border-2 border-[#c0f590] h-48 rounded-[32px] border-b-[8px] flex flex-col items-center justify-center p-6 text-[#58CC02] hover:-translate-y-2 transition-transform">
            ...
            <h3 className="font-['Fredoka_One'] text-xl text-center">
              Fokus Mahasiswa
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          <div className="bg-white border-2 border-gray-200 border-b-[8px] rounded-[32px] p-8 relative hover:-translate-y-2 transition-transform">
            ...
            <p className="font-bold text-gray-600 text-lg mb-8 leading-relaxed">
              &quot;GradReady bener-bener ngebantu aku ngerapihin CV dari nol!
              Fitur AI-nya tau persis keywords apa yang dicari HRD. Alhasil
              dapet panggilan interview lebih banyak dari biasanya!&quot;
            </p>
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h4 className="font-['Fredoka_One'] text-gray-800 text-xl">
                  Budi Santoso
                </h4>
                <p className="text-sm font-bold text-[#1CB0F6]">
                  Diterima sbg UI/UX Designer
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-gray-200 border-b-[8px] rounded-[32px] p-8 relative hover:-translate-y-2 transition-transform">
            <div className="absolute -top-4 left-10 w-8 h-8 bg-white border-l-2 border-t-2 border-gray-200 rotate-45"></div>
            <p className="font-bold text-gray-600 text-lg mb-8 leading-relaxed">
              &quot;Deteksi skill gap-nya juara banget! Aku jadi tau harus
              belajar React JS lebih dalam untuk memperkuat portfolio.
              Latihannya seru berasa main game, dan sekarang aku udah
              kerja!&quot;
            </p>
            <div className="flex items-center gap-4">
              <img
                src="https://images.unsplash.com/photo-1503454537195-1dc5348a6c6c?w=100&h=100&fit=crop"
                alt="Siti"
                className="w-14 h-14 rounded-full border-2 border-gray-200 object-cover"
              />
              <div>
      ...
      >
        <h2 className="font-['Fredoka_One'] text-4xl md:text-5xl text-center mb-16 text-gray-800">
          ...
          <span className="text-[#FF4B4B] italic">ditanyakan</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {[
            {
              q: "Apakah evaluasi CV ini gratis?",
              a: "Tentu! Kamu bisa menggunakan fitur dasar analisa CV secara gratis dengan membuat akun baru.",
            },
            {
              q: "Seperti apa tes mock interview-nya?",
              a: "Kamu akan berbicara langsung (atau chat) dengan AI kami. AI akan menilai kepercayaan diri dan isi dari jawabanmu.",
            },
            {
              q: "Apakah data CV milikku aman?",
              a: "Sangat aman. Kami menggunakan sistem enkripsi kokoh dan tidak akan pernah menjual datamu ke pihak ketiga.",
            },
            {
              q: "Bisa ganti target karir nggak?",
              a: "Tentu dong! Kamu bisa menyesuaikan panduan/roadmap karir sesuai posisi yang sedang jadi fokusmu saat ini.",
            },
          ].map((faq, i) => (
            <div
              key={i}
              className="bg-white border-2 border-gray-200 border-b-[6px] rounded-3xl p-6 hover:border-[#b8f57c] transition-colors"
            >
              <h4 className="font-['Fredoka_One'] text-xl text-gray-800 mb-3">
                {faq.q}
              </h4>
      ...
      <section className="max-w-4xl mx-auto text-center px-6">
        ...
        <p className="text-xl text-gray-500 font-bold mb-10 max-w-xl mx-auto">
          Lebih dari 10,000 lulusan telah bergabung dan mempersiapkan diri
          dengan GradReady. Sekarang giliranmu.
        </p>
        <Button
          variant="primary"
          className="!rounded-2xl text-xl px-12 py-5 shadow-xl hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
        >
      ...
      <footer className="w-full bg-[var(--dark-blue)] py-16 px-6 border-t-4 border-[#1a2235]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="col-span-1 lg:col-span-1 border-b-2 lg:border-b-0 border-[#1a2235] pb-8 lg:pb-0">
            ...
            <p className="text-gray-400 font-bold text-sm leading-relaxed">
              Mempersiapkan fresh graduate menghadapi dunia kerja dengan wawasan
              dan teknologi AI terkini.
            </p>
          </div>
          <div>
            <h4 className="text-gray-500 font-black mb-6 uppercase tracking-wider text-sm">
              Produk
            </h4>
        ...
        <div className="max-w-7xl mx-auto mt-16 pt-8 border-t-2 border-[#1a2235] flex flex-col md:flex-row items-center justify-between gap-4 text-gray-400 font-bold text-sm text-center md:text-left">
          <p>
            &copy; {new Date().getFullYear()} GradReady. All rights reserved.
          </p>
          <div className="flex gap-6">
            <span className="hover:text-[#58CC02] cursor-pointer transition-colors">
              <Camera size={20} />
            </span>
            <span className="hover:text-[#58CC02] cursor-pointer transition-colors">
