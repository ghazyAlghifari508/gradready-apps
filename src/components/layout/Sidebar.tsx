...
const navItems: NavItem[] = [
  ...
  { href: "/pricing", label: "Pricing", icon: CreditCard, group: "billing" },
  {
    href: "/billing",
...
export default function Sidebar() {
  ...
  const currentUserIsAdmin = isAdmin(session);

  const allGroups = Array.from(new Set(navItems.map((i) => i.group)));
  const sidebarGroups = allGroups.filter((g) => g !== "admin" || currentUserIsAdmin);
        ...
        >
          <Link
            ...
            style={{
              ...
              backgroundColor:
                pathname === "/market" ? "rgba(88,204,2,0.08)" : "transparent",
          ...
          <Link
            ...
            style={{
              ...
              color:
                pathname === "/history" ? "var(--green)" : "var(--gray-text)",
              backgroundColor:
                pathname === "/history" ? "rgba(88,204,2,0.08)" : "transparent",
              transition: "all 0.1s ease",
            }}
            onMouseEnter={(e) => {
              if (pathname !== "/history")
        ...
        {session && (
          <Link
            ...
            style={{
              ...
              padding: "12px",
              backgroundColor:
                pathname === "/profile" ? "rgba(28,176,246,0.06)" : "#F7F7F7",
              borderRadius: 12,
              textDecoration: "none",
              border:
                pathname === "/profile"
